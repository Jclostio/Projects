...
public class Solver {
    ...
    public static void menu() throws FileNotFoundException {
        ...
        while (flag) {
            ...
            System.out.println("Which letters were not in the word? (type 'exit' to quit or 'got it' if over): ");
            lettersNotInWord += inputObj.nextLine();
            if (lettersNotInWord.contains("exit")) {
                System.exit(0);
            } else if (lettersNotInWord.contains("got it")) {
                break;
            }
    ...
    private static LinkedList<String> solve(LinkedList<String> wordList, LinkedList<String> wordList2,
            String lettersNotInWord, String lettersInWordKnown, String lettersInWordUnknown) {
        ...
        wordList = (LinkedList<String>) wordList2.clone(); // for the green letters, same as previous conditional
                                                           // statement.
        for (String word : wordList) {
    ...
    private static LinkedList<String> getWords() throws FileNotFoundException {
        ...
        File file = new File("src/wordsBig.txt");
